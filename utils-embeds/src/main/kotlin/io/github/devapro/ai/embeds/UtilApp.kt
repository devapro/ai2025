package io.github.devapro.ai.embeds

import io.github.cdimascio.dotenv.dotenv
import io.github.devapro.ai.embeds.rag.EmbeddingGenerator
import io.github.devapro.ai.embeds.rag.TextChunk
import io.github.devapro.ai.embeds.rag.TextChunker
...
fun main(args: Array<String>) {
    ...
    try {
        ...
        // Configuration
        val inputPath = args.getOrNull(0) ?: "doc-source"
