...
fun ArtistCard() {
    Text("Alfred Sisley")
    Text("3 minutes ago")
}https://github.com/android/snippets/blob/eca9df3fac502dce25839d569adbce916f423203/compose/snippets/src/main/java/com/example/compose/snippets/layouts/LayoutBasicsSnippets.kt#L47-L51
```
...
}https://github.com/android/snippets/blob/eca9df3fac502dce25839d569adbce916f423203/compose/snippets/src/main/java/com/example/compose/snippets/layouts/LayoutBasicsSnippets.kt#L55-L61
```
...
https://github.com/android/snippets/blob/eca9df3fac502dce25839d569adbce916f423203/compose/snippets/src/main/java/com/example/compose/snippets/layouts/LayoutBasicsSnippets.kt#L65-L82
```
...
}https://github.com/android/snippets/blob/eca9df3fac502dce25839d569adbce916f423203/compose/snippets/src/main/java/com/example/compose/snippets/layouts/LayoutBasicsSnippets.kt#L86-L92
```
...
}https://github.com/android/snippets/blob/eca9df3fac502dce25839d569adbce916f423203/compose/snippets/src/main/java/com/example/compose/snippets/layouts/LayoutBasicsSnippets.kt#L96-L105
```
...
}https://github.com/android/snippets/blob/eca9df3fac502dce25839d569adbce916f423203/compose/snippets/src/main/java/com/example/compose/snippets/layouts/LayoutBasicsSnippets.kt#L109-L130
```
...
If your layout needs multiple measurements for some reason, Compose offers a special system,*intrinsic measurements* . You can read more about this feature in[Intrinsic measurements in Compose layouts](https://developer.android.com/develop/ui/compose/layouts/intrinsic-measurements).
...
}https://github.com/android/snippets/blob/eca9df3fac502dce25839d569adbce916f423203/compose/snippets/src/main/java/com/example/compose/snippets/layouts/LayoutBasicsSnippets.kt#L134-L152
```
...
}https://github.com/android/snippets/blob/eca9df3fac502dce25839d569adbce916f423203/compose/snippets/src/main/java/com/example/compose/snippets/layouts/LayoutBasicsSnippets.kt#L156-L161
```
...
() -> Unit`). Slot APIs expose multiple`content`parameters for specific uses. For example,`TopAppBar`allows you to provide the content for`title`,`navigationIcon`, and`actions`.
...
}https://github.com/android/snippets/blob/eca9df3fac502dce25839d569adbce916f423203/compose/snippets/src/main/java/com/example/compose/snippets/layouts/LayoutBasicsSnippets.kt#L165-L176
```
