...
}https://github.com/android/snippets/blob/eca9df3fac502dce25839d569adbce916f423203/compose/snippets/src/main/java/com/example/compose/snippets/layouts/IntrinsicSnippets.kt#L64-L87
```
...
}https://github.com/android/snippets/blob/eca9df3fac502dce25839d569adbce916f423203/compose/snippets/src/main/java/com/example/compose/snippets/layouts/IntrinsicSnippets.kt#L104-L137
```
...
To specify the intrinsics measurements of your custom`Layout`, override the`minIntrinsicWidth`,`minIntrinsicHeight`,`maxIntrinsicWidth`, and`maxIntrinsicHeight`of the[`MeasurePolicy`](https://developer.android.com/reference/kotlin/androidx/compose/ui/layout/MeasurePolicy)interface when creating it.
...
}https://github.com/android/snippets/blob/eca9df3fac502dce25839d569adbce916f423203/compose/snippets/src/main/java/com/example/compose/snippets/layouts/IntrinsicSnippets.kt#L143-L176
```
...
fun Modifier.myCustomModifier(/* ... */) = this then object : LayoutModifier {
    ...
    // Other intrinsics related methods have a default value,
    // you can override only the methods that you need.
}https://github.com/android/snippets/blob/eca9df3fac502dce25839d569adbce916f423203/compose/snippets/src/main/java/com/example/compose/snippets/layouts/IntrinsicSnippets.kt#L182-L206
```
