...
As covered in the[Thinking in Compose](https://developer.android.com/develop/ui/compose/mental-model)documentation, composables should be side-effect free. When you need to make changes to the state of the app (as described in the[Managing state documentation](https://developer.android.com/develop/ui/compose/state)doc),**you should use the Effect APIs so that those side effects are executed in a predictable manner**.
...
}https://github.com/android/snippets/blob/eca9df3fac502dce25839d569adbce916f423203/compose/snippets/src/main/java/com/example/compose/snippets/sideeffects/SideEffectsSnippets.kt#L61-L71
```
...
}https://github.com/android/snippets/blob/eca9df3fac502dce25839d569adbce916f423203/compose/snippets/src/main/java/com/example/compose/snippets/sideeffects/SideEffectsSnippets.kt#L82-L106
```
...
}https://github.com/android/snippets/blob/eca9df3fac502dce25839d569adbce916f423203/compose/snippets/src/main/java/com/example/compose/snippets/sideeffects/SideEffectsSnippets.kt#L110-L128
```
...
fun HomeScreen(
    ...
    /* Home screen content */
}https://github.com/android/snippets/blob/eca9df3fac502dce25839d569adbce916f423203/compose/snippets/src/main/java/com/example/compose/snippets/sideeffects/SideEffectsSnippets.kt#L132-L164
```
...
fun rememberFirebaseAnalytics(user: User): FirebaseAnalytics {
    ...
    return analytics
}https://github.com/android/snippets/blob/eca9df3fac502dce25839d569adbce916f423203/compose/snippets/src/main/java/com/example/compose/snippets/sideeffects/SideEffectsSnippets.kt#L168-L181
```
...
}https://github.com/android/snippets/blob/eca9df3fac502dce25839d569adbce916f423203/compose/snippets/src/main/java/com/example/compose/snippets/sideeffects/SideEffectsSnippets.kt#L187-L217
```
...
}https://github.com/android/snippets/blob/eca9df3fac502dce25839d569adbce916f423203/compose/snippets/src/main/java/com/example/compose/snippets/sideeffects/SideEffectsSnippets.kt#L221-L246
```
...
https://github.com/android/snippets/blob/eca9df3fac502dce25839d569adbce916f423203/compose/snippets/src/main/java/com/example/compose/snippets/sideeffects/SideEffectsSnippets.kt#L258-L263
```
