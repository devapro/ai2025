...
As mentioned in the[Managing state documentation](https://developer.android.com/develop/ui/compose/state), a Composition describes the UI of your app and is produced by running composables. A Composition is a tree-structure of the composables that describe your UI.
...
}https://github.com/android/snippets/blob/54a5c6fec0f9919278d9f94e2e60e094d4edec77/compose/snippets/src/main/java/com/example/compose/snippets/lifecycle/LifecycleSnippets.kt#L33-L39
```
...
@Composable
fun LoginError() { /* ... */ }https://github.com/android/snippets/blob/54a5c6fec0f9919278d9f94e2e60e094d4edec77/compose/snippets/src/main/java/com/example/compose/snippets/lifecycle/LifecycleSnippets.kt#L43-L55
```
...
}https://github.com/android/snippets/blob/54a5c6fec0f9919278d9f94e2e60e094d4edec77/compose/snippets/src/main/java/com/example/compose/snippets/lifecycle/LifecycleSnippets.kt#L59-L68
```
...
https://github.com/android/snippets/blob/54a5c6fec0f9919278d9f94e2e60e094d4edec77/compose/snippets/src/main/java/com/example/compose/snippets/lifecycle/LifecycleSnippets.kt#L72-L88
```
...
}https://github.com/android/snippets/blob/54a5c6fec0f9919278d9f94e2e60e094d4edec77/compose/snippets/src/main/java/com/example/compose/snippets/lifecycle/LifecycleSnippets.kt#L92-L101
```
...
}https://github.com/android/snippets/blob/54a5c6fec0f9919278d9f94e2e60e094d4edec77/compose/snippets/src/main/java/com/example/compose/snippets/lifecycle/LifecycleSnippets.kt#L105-L112
```
...
There is an experimental compiler mode,[Strong Skipping](https://android.googlesource.com/platform/frameworks/support/+/androidx-main/compose/compiler/design/strong-skipping.md), which relaxes the last requirement.
...
interface UiState<T : Result<T>> {
    ...
    val hasError: Boolean
        get() = exception != null
}https://github.com/android/snippets/blob/54a5c6fec0f9919278d9f94e2e60e094d4edec77/compose/snippets/src/main/java/com/example/compose/snippets/lifecycle/LifecycleSnippets.kt#L116-L124
```
