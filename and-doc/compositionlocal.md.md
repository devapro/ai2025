...
}https://github.com/android/snippets/blob/24217733349a11ecfda799e6d60279812773f95f/compose/snippets/src/main/java/com/example/compose/snippets/state/CompositionLocalSnippets.kt#L46-L59
```
...
}https://github.com/android/snippets/blob/24217733349a11ecfda799e6d60279812773f95f/compose/snippets/src/main/java/com/example/compose/snippets/state/CompositionLocalSnippets.kt#L65-L85
```
...
}https://github.com/android/snippets/blob/24217733349a11ecfda799e6d60279812773f95f/compose/snippets/src/main/java/com/example/compose/snippets/state/CompositionLocalSnippets.kt#L91-L116
```
...
fun FruitText(fruitSize: Int) {
    ...
    Text(text = fruitText)
}https://github.com/android/snippets/blob/24217733349a11ecfda799e6d60279812773f95f/compose/snippets/src/main/java/com/example/compose/snippets/state/CompositionLocalSnippets.kt#L122-L130
```
...
val LocalElevations = compositionLocalOf { Elevations() }https://github.com/android/snippets/blob/24217733349a11ecfda799e6d60279812773f95f/compose/snippets/src/main/java/com/example/compose/snippets/state/CompositionLocalSnippets.kt#L136-L142
```
...
}https://github.com/android/snippets/blob/24217733349a11ecfda799e6d60279812773f95f/compose/snippets/src/main/java/com/example/compose/snippets/state/CompositionLocalSnippets.kt#L146-L168
```
...
}https://github.com/android/snippets/blob/24217733349a11ecfda799e6d60279812773f95f/compose/snippets/src/main/java/com/example/compose/snippets/state/CompositionLocalSnippets.kt#L172-L179
```
...
fun MyDescendant(data: DataToDisplay) {
    // Display data
}https://github.com/android/snippets/blob/24217733349a11ecfda799e6d60279812773f95f/compose/snippets/src/main/java/com/example/compose/snippets/state/CompositionLocalSnippets.kt#L189-L205
```
...
}https://github.com/android/snippets/blob/24217733349a11ecfda799e6d60279812773f95f/compose/snippets/src/main/java/com/example/compose/snippets/state/CompositionLocalSnippets.kt#L211-L222
```
...
}https://github.com/android/snippets/blob/24217733349a11ecfda799e6d60279812773f95f/compose/snippets/src/main/java/com/example/compose/snippets/state/CompositionLocalSnippets.kt#L228-L243
```
...
}https://github.com/android/snippets/blob/24217733349a11ecfda799e6d60279812773f95f/compose/snippets/src/main/java/com/example/compose/snippets/state/CompositionLocalSnippets.kt#L249-L271
```
